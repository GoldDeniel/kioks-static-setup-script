# Setup
On a simple, clean and minimal distro (this one is debian based) just simply install the needed packages, and add the service.
```
...
Open your service file: `nano /etc/systemd/system/kiosk.service`
```
[Service]
Type=simple
User=root
WorkingDirectory=/root
ExecStart=/usr/bin/startx /root/kiosk.sh
Restart=always
TimeoutStartSec=0
```
Then run: `systemctl enable kiosk.service`
